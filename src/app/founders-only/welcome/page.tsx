      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-8">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-colors text-lg"
          >
            ...
            Click to open group in WhatsApp
          </a>
        </div>
