...
export const metadata: Metadata = {
  title: "About Jeff Church - Dream Makers HQ",
  description:
  ...
  return (
    <section className="py-20 md:py-32">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">About Jeff Church</h1>
        <p className="mt-4 text-lg text-muted">
          Jeff&rsquo;s full story is on the way. In the meantime, head back to the homepage or get in
          touch.
        </p>
