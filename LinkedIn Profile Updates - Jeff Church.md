# LinkedIn Profile Updates — Jeff Church
...
**Current:** "Work With Me" (likely points to TeamChurch or old site)

**New URL:** https://cpgfoundersgroup.com
...
**Current:** Generic consulting description referencing "hi touch consulting"
...
### 2. Dream Makers — "Founder"
Jan 2024 – Present
**Action:** DELETE

### 3. TeamChurch.co — "Co-Founder and Chief Executive Officer"
Oct 2019 – Present
**Action:** DELETE
...
The operator's playbook for the next generation of CPG founders. Strategic direction, operating infrastructure, and AI-powered tools — built on 35 years, 8 companies, and $700M in exits.

Hands-on advisory programs (90-Day Breakthrough, VIP Days), the MBA for CPG bootcamp, Babu AI (askbabu.ai) — a CPG-specific AI platform with 40+ specialized tools — and a free community of 200+ founders helping each other scale, raise, and exit.
...
- Co-Founder, Proda Soda (Jul 2025 – Present)
- Advisor & Investor, Oku (Oct 2024 – Present)
- Advisor, Melting Forest (Aug 2023 – Present)
- Strategic Advisor, Juni (Nov 2023 – Present)
...
- [ ] Update headline
- [ ] Update website URL to cpgfoundersgroup.com
- [ ] Rewrite About section
- [ ] Rewrite Services section
- [ ] Delete Dream Makers — Accelerators & Bootcamps role
- [ ] Delete Dream Makers — Founder role
- [ ] Delete TeamChurch.co — Co-Founder and CEO role
- [ ] Add CPG Founders Group — Founder role
- [ ] Verify Proda, Oku, Melting Forest, Juni entries are unchanged
